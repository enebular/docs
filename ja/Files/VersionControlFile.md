# File のバージョン管理 {#FileVersionControl}

File の [Version] タブから File をバージョン管理することが出来ます。
本機能は Enterprise Plan のプロジェクトでのみ利用可能です。

## 新しいバージョンの作成 {#CreateNewVersion}

File の Version タブにある [Create New Version] ボタンから新たなバージョンを作成することができます。
...
作成された各 File のバージョンに対して、次の操作が可能です。

| 項目   | 説明                                                   |
| :----- | :----------------------------------------------------- |
| Deploy | 指定したバージョンの File をデプロイすることができます |
| Delete | 指定したバージョンの File を削除することができます     |
